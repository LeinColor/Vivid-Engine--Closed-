	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_SAMPLES, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SAMPLES));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_SAMPLES);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	entrance.SetWindow(hWnd, hInstance);
