...
void VividEngine::Initialize()
{
	...
	axisX->GetComponent<Transform>().SetScale(0.1f, 0.1f, 0.1f);
	axisY->GetComponent<Transform>().SetScale(0.1f, 0.1f, 0.1f);
	axisZ->GetComponent<Transform>().SetScale(0.1f, 0.1f, 0.1f);
